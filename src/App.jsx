  ...
  return (
    <div className="relative min-h-screen bg-black text-white selection:bg-[#ccff00] selection:text-black overflow-x-hidden font-sans">
      ...
      <main className="relative z-10">
        {/* 1. Hero: PORTFOLIO with Manohar in Suit Cutout & Software Developer Subtitle */}
        <Hero onHoverSound={playHover} onClickSound={playClick} />

        {/* 2. Intro: Manohar in Linen Shirt & Bio Glass Card & Tech Stack Badges */}
      ...
      {/* 6. Footer: MANOHAR Illuminated by Emerald Horizon Aurora Glow */}
