            ...
            {isSubmitted ? (
              ...
              >
                ...
                <p className="text-sm text-slate-300 max-w-md mx-auto">
                  Thank you for reaching out. Manohar has received your notification and will reply within 24 hours.
                </p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onBlur={() => setFocusedField(null)}
                    placeholder="Tell Manohar about your project, team, or opportunity..."
