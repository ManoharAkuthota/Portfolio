...
export default function TerminalShowcase({ onHoverSound, onClickSound }) {
  ...
  const [cliHistory, setCliHistory] = useState([
    { type: 'input', text: 'manohar --status' },
    { type: 'output', text: 'STATUS: READY // Java Spring Boot 3 + React 19 + AI Automation Systems' },
    { type: 'input', text: 'curl -s https://api.manohar.dev/v1/availability' },
    { type: 'output', text: '{ "available": true, "roles": ["Java Enterprise Backend", "React Frontend", "AI Systems"] }' },
  ]);
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-[#080d24] border-b border-white/10 relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-3 font-mono text-xs text-slate-400 hidden sm:inline">
              manohar@workstation: ~/production-source
            </span>
          </div>
