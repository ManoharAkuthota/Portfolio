          ...
          >
            <div>
              ...
              <p className="text-zinc-400 text-sm sm:text-base mt-2 sm:mt-3 leading-relaxed">
                Have an enterprise project, AI initiative, or full-stack opportunity in mind? Let’s connect and create something exceptional.
              </p>
            </div>
            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="https://www.linkedin.com/in/manohar-akuthota/"
                    target="_blank"
                    rel="noopener noreferrer"
                    onMouseEnter={onHoverSound}
                    className="w-10 h-10 rounded-full border border-zinc-800 bg-zinc-950 flex items-center justify-center text-zinc-400 hover:text-white hover:border-[#0077b5] transition-all duration-300"
                    aria-label="LinkedIn"
                  >
